...
<body>
    ...
    <!-- Profile Section -->
<section id="profil" class="py-16 px-6 bg-gray-50">
    <div class="mb-10"></div>
    <div class="container mx-auto text-center">
        <h2 class="font-bold text-2xl md:text-4xl text-blue-600">Berita</h2>
        <p class="mt-4 text-gray-600">Perndaftaran SMA IT HSI IDN telah di buka! Ayo pastisipasikan diri mu sekarang!</p>
        
        <!-- Profile Content -->
        <div class="mt-8 flex flex-col md:flex-row items-center justify-center space-y-8 md:space-y-0 md:space-x-8">
            <!-- Profile Image -->
            <div class="w-full md:w-1/2">
                <img src="./src/img/sekolah.jpg" alt="Profile Image" class="w-full h-auto object-cover rounded-lg shadow-md">
            </div>
            
            <!-- Profile Description -->
            <div class="w-full md:w-1/2">
                <h3 class="text-xl font-semibold text-blue-600">What's News?</h3>
                <p class="mt-4 text-gray-600">
                    SMA IT HSI IDN adalah institusi pendidikan yang berkomitmen untuk memberikan pendidikan berkualitas tinggi di bidang Teknologi Informasi dan Keagamaan. Kami menawarkan berbagai program unggulan untuk mendukung perkembangan siswa dalam aspek akademik dan non-akademik.
                </p>
                <p class="mt-4 text-gray-600">
                    Dengan fasilitas modern dan pengajaran yang berpengalaman, kami berusaha untuk menciptakan lingkungan belajar yang kondusif dan inspiratif. Bergabunglah dengan kami dan jadilah bagian dari komunitas yang bersemangat untuk mencapai kesuksesan.
                </p>
                <a href="./berita.html" class="mt-8 inline-block bg-blue-600 text-white py-2 px-6 rounded-full shadow-md hover:bg-blue-700">Learn More</a>
            </div>
        </div>
    </div>
</section>
