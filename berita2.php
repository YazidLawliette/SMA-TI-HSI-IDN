     ...
     <section class="pt-24 pb-16 px-6 bg-gray-50">
        <div class="container mx-auto">
            <div class="max-w-4xl mx-auto">
                <!-- Berita Title -->
                <h1 class="text-3xl font-bold text-blue-600 mb-6">Kegiatan Ekstrakurikuler Unggulan.</h1>
                ...
                <!-- Berita Image -->
                <img src="./src/img/DSC_0603.JPG" alt="Penerimaan Siswa Baru Tahun 2024" class="w-full h-96 object-cover rounded-lg mb-8">

                <!-- Berita Content -->
                <div class="text-gray-700 leading-7">
                    <p class="mb-6">
                        Di SMA IT HSI IDN, kami percaya bahwa pendidikan tidak hanya tentang penguasaan materi akademik, tetapi juga tentang pengembangan karakter, keterampilan, dan bakat setiap siswa. Oleh karena itu, kami menyediakan berbagai program ekstrakurikuler yang dirancang untuk membantu siswa menemukan minat mereka, mengasah kemampuan, dan berkontribusi secara positif di lingkungan sekolah serta masyarakat.
                    </p>
                    <p class="mb-6">
                        1. Ekstrakurikuler Keagamaan
Sebagai sekolah berbasis Islam Terpadu, kami menyediakan program ekstrakurikuler keagamaan yang bertujuan untuk meningkatkan pemahaman dan pengamalan nilai-nilai Islam. Kegiatan ini meliputi:

Tahfidzul Qur'an: Program intensif menghafal Al-Qur'an dengan bimbingan khusus.
Kajian Islam: Kegiatan diskusi dan pembelajaran tentang ilmu agama Islam secara mendalam.
Rohis (Rohani Islam): Organisasi rohani yang mengelola kegiatan keagamaan di lingkungan sekolah.
                    </p>
                    <p class="mb-6">
                        2. Olahraga
Untuk menjaga keseimbangan fisik dan mental siswa, kami menawarkan beberapa kegiatan olahraga yang dapat dipilih:

Futsal: Kegiatan olahraga populer ini melatih kerjasama tim, ketangkasan, dan kekuatan fisik.
Basket: Melalui olahraga basket, siswa belajar disiplin, kerja sama tim, dan kepemimpinan.
Pencak Silat: Sebagai seni bela diri tradisional Indonesia, pencak silat mengajarkan ketangkasan dan kepercayaan diri.
                    </p>
                    <p class="mb-6">
                        Untuk informasi lebih lanjut mengenai Extraculicular dan jenis jenis nya, Anda dapat mengunjungi halaman <a href="#" class="text-blue-500 underline">Pendaftaran Siswa Baru</a> atau menghubungi nomor telepon yang tertera di halaman kontak kami.
                    </p>
                </div>
