     ...
     <section class="pt-24 pb-16 px-6 bg-gray-50">
        <div class="container mx-auto">
            <div class="max-w-4xl mx-auto">
                <!-- Berita Title -->
                <h1 class="text-4xl font-bold text-blue-600 mb-6">Penerimaan Siswa Baru Tahun 2024</h1>
                ...
                <!-- Berita Image -->
                <img src="./src/img/DSC_0152.JPG" alt="Penerimaan Siswa Baru Tahun 2024" class="w-full h-96 object-cover rounded-lg mb-8">

                <!-- Berita Content -->
                <div class="text-gray-700 leading-7">
                    <p class="mb-6">
                        SMA IT HSI IDN kembali membuka pendaftaran untuk penerimaan siswa baru tahun ajaran 2024. Sekolah kami menawarkan berbagai program unggulan yang memadukan pendidikan agama dan ilmu pengetahuan modern.
                    </p>
                    <p class="mb-6">
                        Calon siswa akan mengikuti serangkaian tes seleksi, dan kami juga menyediakan berbagai program beasiswa bagi siswa berprestasi. Dengan fasilitas yang lengkap dan tenaga pengajar yang berpengalaman, kami siap membimbing generasi penerus bangsa menjadi pribadi yang unggul di bidang akademik dan keagamaan.
                    </p>
                    <p class="mb-6">
                        Pendaftaran siswa baru sudah dibuka mulai 1 September 2024 hingga 31 Desember 2024. Segera daftarkan diri Anda dan jangan lewatkan kesempatan emas ini!
                    </p>
                    <p class="mb-6">
                        Untuk informasi lebih lanjut mengenai pendaftaran dan prosedur seleksi, Anda dapat mengunjungi halaman <a href="#" class="text-blue-500 underline">Pendaftaran Siswa Baru</a> atau menghubungi nomor telepon yang tertera di halaman kontak kami.
                    </p>
                </div>
